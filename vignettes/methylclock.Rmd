...
We can compute the correlation among biological clocks using the function `plotCorClocks` that requires the package `PerformanceAnalytics` to be installed in your computer. 
