...
We can set `min.perc` to allow estimations with less than 80% of conicidence between CpGs in our data and CpGs in clock coefficients,

```{r DNAmAgemp_horvath, warning=TRUE}
age.example55 <- DNAmAge(MethylationData, min.perc = 0.25)
age.example55
```

Setting `min.perc = 0.25` we can estimate DNAmAge with Skin clock.
